...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/Sanekhire/chatgpt-client"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.0.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/Sanekhire/chatgpt-client"
  spec.metadata["changelog_uri"] = "https://github.com/Sanekhire/chatgpt-client/blob/master/CHANGELOG.md"
